// ignore_for_file: unused_local_variable, avoid_single_cascade_in_expression_statements, avoid_print, unused_catch_clause

import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:anime/utils/Constants.dart';
  ...
  Future<bool> updateOrderNotification({required String token}) async {
    ...
    try {
      final response =
        ...
        "registration_ids": [token],
        "notification": {
          "body": "Khách hàng vừa cập nhật đơn hàng.",
